...
`)}let I=[],v=null,E=null;window.addEventListener("message",t=>{if(t.source!==window)return;const e=t.data;if(!(!e||e.source!==X))switch(e.type){case"AG_FRAMEWORK_DETECT_RESULT":I=e.payload.frameworks;break;case"AG_COMPONENT_INFO":v==null||v(e.payload),v=null;break;case"AG_SOURCE_INFO":E==null||E(e.payload),E=null;break}});function At(t){return new Promise(e=>{v=e,window.postMessage({source:X,type:"AG_COMPONENT_INFO_REQUEST",payload:{elementSelector:t}},"*"),setTimeout(()=>{v=null,e(null)},2e3)})}function Mt(t){return new Promise(e=>{E=e,window.postMessage({source:X,type:"AG_PROBE_SOURCE",payload:{elementSelector:t}},"*"),setTimeout(()=>{E=null,e(null)},2e3)})}const _=Z(),S=new nt(window.location.pathname),d=new V(_.getElementById("agentation-toolbar")),$=new tt(_.getElementById("agentation-highlights"),_.getElementById("agentation-markers")),y=new et(_.getElementById("agentation-popups"));let x=null,Lt="standard",h=[];const k=new Map;function Y(t){if(k.has(t))return;const e=t.getBoundingClientRect(),n=document.createElement("div");n.setAttribute("data-agentation","multi-select-highlight"),n.style.cssText=`
    ...
    box-sizing: border-box;
  `,document.body.appendChild(n),k.set(t,n)}function Nt(t){const e=k.get(t);e&&(e.remove(),k.delete(t))}function F(){k.forEach(t=>t.remove()),k.clear()}let f=!1,T=!1,A=0,M=0,a=null,C=null;function B(){$.clearAllMarkers(),S.getAll().forEach((t,e)=>{$.addMarker(t.id,{x:t.boundingBox.x,y:t.boundingBox.y},e+1)}),d.setAnnotationCount(S.getAll().length)}B();d.on("toggle",()=>{d.toggle(),d.isActive||($.clearHoverHighlight(),y.hide(),document.body.style.cursor="",F(),h=[],f=!1,T=!1,a&&(a.remove(),a=null),C=null)});d.on("copy",()=>{const t=Et(S.getAll(),Lt);navigator.clipboard.writeText(t).catch(()=>{})});d.on("clear",()=>{S.clearAll(),B()});d.on("freeze",()=>{});d.on("settings",()=>{f=!f,f||(a&&(a.remove(),a=null),T=!1),document.body.style.cursor=f?"crosshair":""});document.body.addEventListener("mousemove",t=>{if(!d.isActive)return;if(f&&T&&a){const n=Math.min(t.clientX,A),o=Math.min(t.clientY,M),i=Math.abs(t.clientX-A),r=Math.abs(t.clientY-M);a.style.left=`${n}px`,a.style.top=`${o}px`,a.style.width=`${i}px`,a.style.height=`${r}px`;return}if(f)return;const e=D(t.clientX,t.clientY);if(e&&!z(e)){const n=O(e,2);$.showHoverHighlight(e,n),document.body.style.cursor=Ot(e)?"text":"crosshair"}else $.clearHoverHighlight(),document.body.style.cursor=""});document.body.addEventListener("mousedown",t=>{if(!d.isActive||!f)return;const e=t.target;z(e)||(t.preventDefault(),t.stopPropagation(),T=!0,A=t.clientX,M=t.clientY,a=document.createElement("div"),a.setAttribute("data-agentation","area-overlay"),a.style.cssText=`
    position: fixed;
    z-index: 2147483641;
    pointer-events: none;
    left: ${A}px;
